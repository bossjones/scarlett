...
class ScarlettTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ### WAIT TILL WE START USING HTTP REQUESTS # mock.Mock(return_value=self.https_connection), ())
        import scarlett
    ...
    ### WAIT TILL WE START USING HTTP REQUESTS #     self.https_connection.getresponse.return_value = http_response
