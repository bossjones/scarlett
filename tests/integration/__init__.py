...
class ScarlettIntegrationTestCase(unittest.TestCase):

    """This is a real system check, run this before starting up the scarlett process to see if all services are enabled
    """
    ...
    @classmethod
    def setUpClass(cls):
        super(ScarlettIntegrationTestCase, cls).setUpClass()
    ...
    def setUp(self):
        super(ScarlettIntegrationTestCase, self).setUp()
