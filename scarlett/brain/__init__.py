...
class ScarlettBrain(object):
    ...
    def __init__(self, brain_name, **kwargs):
      ...
      self.brain_sub    = redis.client.Redis(host=self.redis_host, port=self.redis_port , db=self.redis_db)
    ...
    def set_keyword_identified(self,keyword_value):
        return self.redis_server.set("scarlett_main_keyword_identified", keyword_value)
